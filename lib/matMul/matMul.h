...
/*! 
    ...
    @param[in]      A Pointer to the first matrix in ROW MAJOR format, the matrix is allocated in device memory
    @param[in]      B Pointer to the second matrix in ROW MAJOR format, the matrix is allocated in device memory
    @param[out]     C Pointer to the resultant matrix in ROW MAJOR format, the matrix is allocated in device memory
